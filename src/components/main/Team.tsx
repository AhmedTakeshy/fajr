...
export default function Team() {
    return (
        <MotionSection
            ...
            <h1 className='my-6 font-bold text-7xl'>العملاء</h1>
            <section id="testimonials" className='grid w-full gap-10 my-4 lg:grid-cols-3 md:grid-cols-2 place-content-center'>
