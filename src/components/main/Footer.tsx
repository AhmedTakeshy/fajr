        ...
        <section className='grid gap-3 text-center xl:grid-cols-2 xl:text-justify place-content-center xl:place-content-between xl:col-span-2'>
          ...
          <div className='order-1 xl:order-none'>
            <div className='flex items-center justify-center gap-3 mb-2 xl:justify-end'>
              <Link aria-label='navigate to tiktok' href="https://www.tiktok.com/@fajer_bg?_t=8hStlZjRw18&_r=1" target="_blank" className='relative group'>
              ...
              <Link aria-label='navigate to telegram channel' href="https://t.me/gghhtyruiopew" target="_blank" className='group'>
                <FaTelegram size={20} className="group-hover:text-[#2AABEE] duration-500 transition" />
              </Link>
              <Link aria-label='send email' href="mailto:Fajer.baghdad89@gmail.com" className='group'>
                <HiMail size={25} className="transition-all duration-500 group-hover:text-rose-400" />
              </Link>
              <Link aria-label='navigate to facebook' href="https://www.facebook.com/profile.php?id=100077916062174&mibextid=ZbWKwL" target="_blank" className=' group'>
                <FaFacebookF size={20} className="group-hover:text-[#1877f2] duration-500 transition" />
              </Link>
              <Link aria-label='navigate to instagram' href="https://instagram.com/fjer_b?igshid=OGQ5ZDc2ODk2ZA==" target="_blank" className='relative before:hover:bg-gradient-to-br from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] before:rounded-[6px] before:w-full before:h-full before:opacity-0 before:hover:opacity-100 before:duration-1000 before:transition-all before:absolute before:z-0 '>
