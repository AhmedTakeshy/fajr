...
export default function Footer() {
  ...
  return (
    <footer id='about' className='grid w-full mt-auto bg-gray-300 md:grid-cols-2 place-content-between place pt-9 dark:bg-sky-950'>
      ...
      <Suspense fallback={<Skeleton className="w-[887.5px] h-[377px] rounded-lg" />}>
        <MapPage />
      </Suspense>
    </footer >
  )
