    ...
    return (
        <div className="flex flex-col items-center w-full h-[calc(100vh-13.68rem)] space-x-8 space-y-16 lg:flex-row lg:space-y-0 2xl:space-x-0">
            <div className="flex flex-col items-center justify-center w-full text-center lg:w-1/2 lg:px-2 xl:px-0">
                ...
                <p className="mt-2 text-4xl font-bold tracking-wider text-gray-300 md:text-5xl lg:text-6xl">خطا بالخادم</p>
                <p className="my-12 text-lg text-gray-500 md:text-xl lg:text-2xl">للاسف, حدث خطا في خوادمنا.</p>
                <Button variant="outline" size="lg" onClick={reset}>
                    حاول مرة اخري
                </Button>
            </div>
            <div className="flex justify-center w-1/2 p-4 lg:h-full lg:items-baseline">
                <Image src="/imgs/not-found.png" alt="pageNot found" width={700} height={500} className="object-cover" />
            </div>
        </div>
    )
}